...
class TMPMELA_FEATURED_CONTENT {
	...
	public static function customize_register( $wp_customize ) {
		$wp_customize->add_section( 'TMPMELA_FEATURED_CONTENT', array(
			...
			'description'    => sprintf( __( 'Use a <a href="%1$s">tag</a> to feature your posts. If no posts match the tag, <a href="%2$s">sticky posts</a> will be displayed instead.', 'shopinia' ),
				esc_url( add_query_arg( 'tag', _x( 'featured', 'featured content default tag slug', 'shopinia' ), admin_url( 'edit.php' ) ) ),
		...
		$wp_customize->add_control( 'featured-content[tag-name]', array(
			'label'    => esc_html__( 'Tag Name', 'shopinia' ),
			'section'  => 'TMPMELA_FEATURED_CONTENT',
			'priority' => 20,
		) );
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'    => esc_html__( 'Don&rsquo;t display tag on front end.', 'shopinia' ),
			'section'  => 'TMPMELA_FEATURED_CONTENT',
			'type'     => 'checkbox',
			'priority' => 30,
		) );
