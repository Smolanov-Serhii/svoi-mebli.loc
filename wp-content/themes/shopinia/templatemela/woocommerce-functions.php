...
function woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	ob_start();	
	?>
	<a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="<?php esc_attr_e('View your shopping cart', 'shopinia'); ?>"><div class="cart-label"><?php echo esc_html_e('My Bag','shopinia'); ?></div>
